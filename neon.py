...
class Spammer(threading.Thread):
    ...
    def run(self):
        global N
        self.Lock.acquire()
        print ("\x1b[38;5;228mLucifer\x1b[38;5;255m@\x1b[38;5;207mThread Ready #%4d |"% (self.num))
        self.Lock.release()
        time.sleep(1)
        while True:
            try:
...
class MainLoop():
    ...
    def setup(self):
        ...
        while True:        
            url = input('\x1b[38;5;228mLucifer\x1b[38;5;255m@\x1b[38;5;207mProxy #\x1b[38;5;255m Enter URL: ')
            ...
            try:
                ...
                print ('\x1b[38;5;228mLucifer\x1b[38;5;255m@\x1b[38;5;207mProxy #\x1b[38;5;255m Could Not Open Url')
        while True:            
            try:
                l = str(input('\x1b[38;5;228mLucifer\x1b[38;5;255m@\x1b[38;5;207mProxy #\x1b[38;5;255m Enter Proxy List: '))
                in_file = open(l,"r")
                lista = []
                for i in in_file:
                ...
                print ('\x1b[38;5;228mLucifer\x1b[38;5;255m@\x1b[38;5;207mProxy #\x1b[38;5;255m Error to read file.')
        while True:                
            try:
                num_threads = int(input('\x1b[38;5;228mLucifer\x1b[38;5;255m@\x1b[38;5;207mProxy #\x1b[38;5;255m Number Of Thread[800] : '))
            except:
                num_threads = 800
            break
